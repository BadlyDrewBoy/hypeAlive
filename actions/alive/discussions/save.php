...
$annotation = new hjGroupTopicPost($guid);
...
//			&& !check_entity_relationship($annotation->owner_guid, 'unsubscribed', $original_container->guid)
	...
	if (!$guid) {
		...
		add_to_river('framework/river/stream/grouptopicpost', 'stream:grouptopicpost', $annotation->owner_guid, $annotation->guid, $container->access_id, $annotation->time_created);
	}
