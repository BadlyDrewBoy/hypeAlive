...
// Set plugin setting values as constants
...
define('HYPEALIVE_MAX_FORUM_COMMENT_DEPTH', (int)elgg_get_plugin_setting('max_forum_comment_depth', 'hypeAlive'));
define('HYPEALIVE_FORUM_COMMENT_FORM', elgg_get_plugin_setting('forum_comment_form', 'hypeAlive'));
define('HYPEALIVE_FORUM_COMMENT_FORM_POSITION', elgg_get_plugin_setting('forum_comment_form_position', 'hypeAlive'));
define('HYPEALIVE_FORUM_COMMENTS_ORDER', elgg_get_plugin_setting('forum_comments_order', 'hypeAlive'));
define('HYPEALIVE_FORUM_COMMENTS_LOAD_STYLE', elgg_get_plugin_setting('forum_comments_load_style', 'hypeAlive'));
define('HYPEALIVE_FORUM_COMMENTS_LIMIT', (int)elgg_get_plugin_setting('forum_comments_limit', 'hypeAlive'));
define('HYPEALIVE_FORUM_COMMENTS_LOAD_LIMIT', (int)elgg_get_plugin_setting('forum_comments_load_limit', 'hypeAlive'));
