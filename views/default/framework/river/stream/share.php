...
if (elgg_in_context('substream-view')) {
	...
	$text = elgg_echo('hj:alive:river:substream:share', array($subject->name, $friendly_time));
	...
	$summary = elgg_echo('hj:alive:river:stream:share', array($subject_link, $object_link));
