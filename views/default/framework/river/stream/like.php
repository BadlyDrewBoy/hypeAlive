...
if (elgg_in_context('substream-view')) {
	...
	$text = elgg_echo('hj:alive:river:substream:likr', array($subject->name, $friendly_time));
	...
	$summary = elgg_echo('hj:alive:river:stream:like', array($subject_link, $object_link));
